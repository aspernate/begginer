...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            File your_file_name = File.createTempFile("/tmp/1.txt", null);
    ...
    public static class Human {
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            for(int i = 0; i < size; i++){
                ...
                System.out.println(assets.get(assets.size()-1).getName());
                assets.get(assets.size()-1).setPrice(Double.parseDouble(reader.readLine()));
                System.out.println(assets.get(assets.size()-1).getPrice());
            }
        }
    }
}

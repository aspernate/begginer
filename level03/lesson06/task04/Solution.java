...
public class Solution
{
    ...
    {
        String win_path = "It's Windows path: \"C:\\Program Files\\Java\\jdk1.7.0\\bin\"";
        String java_string = "It's Java string: \\\"C:\\\\Program Files\\\\Java\\\\jdk1.7.0\\\\bin\\\"";
        System.out.println(win_path);

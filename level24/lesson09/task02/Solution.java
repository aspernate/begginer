                ...
                if(result == 0) {
                    ...
                    if(result == 0) {
                        ...
                        if(stock1.containsKey("change")) {
                            price1 = (Double) stock1.get("change");
                        }
                        else {
                            price1 = (Double) stock1.get("last") - (Double) stock1.get("open");
                        }
                        if(stock2.containsKey("change")) {
                            price2 = (Double) stock2.get("change");
                        }
                        else {
                            price2 = (Double) stock2.get("last") - (Double) stock2.get("open");
                        }
